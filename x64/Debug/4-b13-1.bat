@echo off
get_input_data.exe 4-b13.dat 4-b13-1 | 4-b13-1-汉诺塔-步数记录-静态局部变量.exe > 4-b13-1.out
...
get_input_data.exe 4-b13.dat 4-b13-2 | 4-b13-1-汉诺塔-步数记录-静态局部变量.exe > 4-b13-2.out
...
get_input_data.exe 4-b13.dat 4-b13-3 | 4-b13-1-汉诺塔-步数记录-静态局部变量.exe > 4-b13-3.out
...
get_input_data.exe 4-b13.dat 4-b13-4 | 4-b13-1-汉诺塔-步数记录-静态局部变量.exe > 4-b13-4.out
